...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("157.90.92.153".to_owned());
    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
    pub static ref APP_NAME: RwLock<String> = RwLock::new("PN-Fernwartung".to_owned());
...
pub const RS_PUB_KEY: &str = "03ztMAgYHT+oLktj4azdmxWWWHegBad8h2jquDPy4oc=";
